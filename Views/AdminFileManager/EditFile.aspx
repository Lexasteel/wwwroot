<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<Ergomera.Webserver.Models.FileManager.ManageFile>" %>
        ...
        <fieldset>
            ...
            <%}
              ...
              Writer.Write(Html.Hidden("isedit", Model.IsEdit));
                 %>
            <p>
                <%=Html.TextArea("Content", Model.Content, new {rows=30, cols=140})%>
            </p>
            <p>
                <%if (Model.IsEdit) {%>
